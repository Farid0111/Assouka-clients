...
class SelectionMetsAEntree extends StatefulWidget {
  @override
  _SelectionMetsAEntreeState createState() => _SelectionMetsAEntreeState();
}

class _SelectionMetsAEntreeState extends State<SelectionMetsAEntree> {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text("Argent -> Entrée", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
            Padding(
