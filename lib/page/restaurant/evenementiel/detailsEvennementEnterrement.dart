...
class DetailsEvennementEnterrement extends StatefulWidget {
  @override
  _DetailsEvennementEnterrementState createState() => _DetailsEvennementEnterrementState();
}

class _DetailsEvennementEnterrementState extends State<DetailsEvennementEnterrement> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(margin: EdgeInsets.all(10.0),child: Text("Enterrement", style: GoogleFonts.acme(fontSize: 20, fontWeight: FontWeight.bold),)),
                    ],
                  ),
