...
class SelectionMetsADessert extends StatefulWidget {
  @override
  _SelectionMetsADessertState createState() => _SelectionMetsADessertState();
}

class _SelectionMetsADessertState extends State<SelectionMetsADessert> {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text("Argent -> Déssert", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("Veuillez choisir quelques déssert", style: TextStyle(fontSize: 17),),
            ),
            CustomCheckBoxGroup(
