...
class DetailsEvennementMariage extends StatefulWidget {
  @override
  _DetailsEvennementMariageState createState() => _DetailsEvennementMariageState();
}

class _DetailsEvennementMariageState extends State<DetailsEvennementMariage> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(margin: EdgeInsets.all(10.0),child: Text("Mariage", style: GoogleFonts.acme(fontSize: 20, fontWeight: FontWeight.bold),)),
                    ],
                  ),
