...
class SelectionMetsGApperitif extends StatefulWidget {
  @override
  _SelectionMetsGApperitifState createState() => _SelectionMetsGApperitifState();
}

class _SelectionMetsGApperitifState extends State<SelectionMetsGApperitif> {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text("Gold -> Apérifs", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
            Padding(
