...
class DetailsEvennementBateme extends StatefulWidget {
  @override
  _DetailsEvennementBatemeState createState() => _DetailsEvennementBatemeState();
}

class _DetailsEvennementBatemeState extends State<DetailsEvennementBateme> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(margin: EdgeInsets.all(10.0),child: Text("Batême", style: GoogleFonts.acme(fontSize: 20, fontWeight: FontWeight.bold),)),
                    ],
                  ),
