...
class SelectionMetsGDessert extends StatefulWidget {
  @override
  _SelectionMetsGDessertState createState() => _SelectionMetsGDessertState();
}

class _SelectionMetsGDessertState extends State<SelectionMetsGDessert> {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text("Gold -> Déssert", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
            Padding(
